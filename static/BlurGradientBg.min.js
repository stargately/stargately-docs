!(function (t, e) {
  ...
  function i(t, e, i) {
    return (
      ...
      l(
        t,
        u() ? Reflect.construct(e, i || [], h(t).constructor) : e.apply(t, i),
      )
    );
  }
  function r(t, e) {
  ...
  var F = (function (t) {
      function e() {
        ...
        return r(this, e), l((t = i(this, e, [n, s, a])), t);
      }
      return (
        o(e, t),
        s(e, [
          ...
          },
          {
            ...
            value: function (t) {
              ...
              for (var r = 0, n = 0, s = e.length; n < s; n += i)
                S.fromArray(e, n),
                  (r = Math.max(r, this.bounds.center.squaredDistance(S)));
            ...
            value: function () {
              ...
              this.gl.renderer.state.currentProgram === this.id ||
                ...
                this.uniformLocations.forEach(function (e, i) {
                  ...
                  if (s.value.texture)
                    return (r += 1), s.value.update(r), I(t.gl, i.type, e, r);
        ...
        function t() {
          var e =
              arguments.length > 0 && void 0 !== arguments[0]
                ...
                : {},
            i = e.canvas,
            n = void 0 === i ? document.createElement("canvas") : i,
            s = e.width,
            a = void 0 === s ? 300 : s,
            h = e.height,
            o = void 0 === h ? 150 : h,
                ...
                s.forEach(function (t) {
                  t.program.transparent
                    ...
                    0 === t.renderOrder &&
                      t.program.depthTest &&
                      i &&
                      (t.worldMatrix.getTranslation(j),
  ...
  var X = function (t, e) {
    ...
    Z = (function (t) {
      function e() {
        ...
        r(this, e),
          ((t = i(this, e, [n, s, a, h])).onChange = function () {}),
          (t._target = t);
        var o = ["0", "1", "2", "3"];
        return l(
          t,
        ...
        s(e, [
          ...
          },
          {
            ...
            value: function (t, e, i, r) {
              return t.length
                ? this.copy(t)
                : (V(this._target, t, e, i, r), this.onChange(), this);
            },
          },
          {
            key: "rotateX",
          ...
          },
          {
            ...
            value: function (t, e) {
              return (
                e ? W(this._target, t, e) : W(this._target, this._target, t),
                this.onChange(),
                this
              );
            },
  ...
  var rt = (function (t) {
    function e() {
      var t,
        ...
        v =
          arguments.length > 10 && void 0 !== arguments[10] ? arguments[10] : 1,
        p =
          arguments.length > 11 && void 0 !== arguments[11] ? arguments[11] : 0,
        m =
          arguments.length > 12 && void 0 !== arguments[12] ? arguments[12] : 0,
        y =
          arguments.length > 13 && void 0 !== arguments[13] ? arguments[13] : 0,
        _ =
          arguments.length > 14 && void 0 !== arguments[14] ? arguments[14] : 0,
        b =
          arguments.length > 15 && void 0 !== arguments[15] ? arguments[15] : 1;
      return (
        r(this, e),
        l((t = i(this, e, [n, s, a, h, o, u, c, f, d, g, v, p, m, y, _, b])), t)
      );
    }
    return (
      o(e, t),
      s(e, [
        ...
        },
        {
          key: "sub",
          value: function (t, e) {
            return e ? it(this, t, e) : it(this, this, t), this;
          },
        },
        {
          key: "multiply",
      ...
      return (
        ...
        s(e, [
          ...
          },
          {
            ...
            value: function () {
              return (
                a(h(e.prototype), "updateMatrixWorld", this).call(this),
          ...
          },
          {
            key: "lookAt",
            value: function (t) {
              return a(h(e.prototype), "lookAt", this).call(this, t, !0), this;
            },
          },
          {
            key: "project",
          ...
          },
          {
            ...
            value: function (t) {
              return (
                t.applyMatrix4(ht.inverse(this.projectionMatrix)),
  ...
  var ft = (function (t) {
      function e() {
        var t,
          ...
          d =
            arguments.length > 8 && void 0 !== arguments[8] ? arguments[8] : 1;
        return r(this, e), l((t = i(this, e, [n, s, a, h, o, u, c, f, d])), t);
      }
      return (
        o(e, t),
        s(e, [
              ...
              if (
                ...
                if (
                  ...
                  this.generateMipmaps &&
                    ...
                    (pt(this.image.width) && pt(this.image.height))
    ...
    kt = (function (t) {
      function e(t) {
        ...
        return (
          ...
          Array.isArray(t)
            ? l(n, (n = i(this, e, f(t))))
            : l(n, (n = i(this, e, f(wt.apply(Mt, arguments)))))
        );
      }
      return (
        o(e, t),
          ...
          },
          {
            ...
            value: function (t) {
              return Array.isArray(t)
                ? this.copy(t)
                : this.copy(wt.apply(Mt, arguments));
            },
          },
          {
            key: "copy",
  ...
  var Ct = (function (t) {
      function e() {
        var t,
          ...
          s =
            arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : n;
        return r(this, e), l((t = i(this, e, [n, s])), t);
      }
      return (
        o(e, t),
        s(e, [
          ...
          },
          {
            key: "cross",
            value: function (t, e) {
              return e ? St(t, e) : St(this, t);
            },
          },
          {
            key: "scale",
            value: function (t) {
              return Rt(this, this, t), this;
            },
          },
          {
            key: "normalize",
    ...
    Pt = (function (t) {
      function e(t) {
        ...
        return (
          e.buildPlane(_, b, x, E, a, o, 0, v, p),
          Object.assign(g, {
  ...
  !(function () {
    !(function (t, e, i) {
      ...
      if (
        (v(i.random(), e),
        "object" == ("undefined" == typeof module ? "undefined" : g(module)) &&
          module.exports)
      ) {
        module.exports = l;
        try {
  ...
  var Bt = (function () {
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (((this.palette = []), 0 == t.length))
                ...
                for (var i = f(t), r = i.length; r < 6; r++) {
                  var n = r % i.length;
                  t.push(i[n]);
                }
                this.palette = t;
    ...
    Ot = (function (t) {
      function e() {
        ...
        return (
          r(this, e),
          ((t = i(this, e, [n, 4])).name = "blur-gradient"),
          t.start(),
          t
        );
      }
        ...
        s(e, [
          {
            key: "_initRtt",
            value: function () {
              (this.rtt = new _t(this.gl, { width: 512, height: 512 })),
                (this.rttCamera = new lt(this.gl, {
                  left: -0.5,
                  right: 0.5,
                  bottom: -0.5,
                  top: 0.5,
                ...
                (this.rttPlaneGeo = new Pt(this.gl, {})),
                (this.rttProgram = new U(this.gl, {
                  ...
                  uniforms: {
                    u_time: { value: 0 },
                    u_resolution: {
                      value: new Ct(2 * this.canvasW, 2 * this.canvasH),
                    },
          ...
          },
          {
            key: "_resetSeed",
            value: function () {
              (this.rttProgram.uniforms.u_rand_1.value =
                200 * this.rng() - 100),
                (this.rttProgram.uniforms.u_rand_2.value =
                  200 * this.rng() - 100);
            },
          },
          {
